...
void setup() {
  ...
  imu1.settings.device.commInterface = 1; // Set mode to I2C 
  imu1.settings.device.mAddress = 0x1C; // Set mag address to 0x1E
  imu1.settings.device.agAddress = 0x6A; // Set ag address to 0x6B
...
void loop() 
{
  ...
  // change the player number below  
  Serial.print("2,");Serial.print(imu->roll);Serial.print(",");Serial.println(imu->pitch);
